...
- Reuse the current Git branch, do NOT create a new branch
- NEVER discard any existing changes
- Migrate from javax.* to jakarta.* namespace if not already done
- Update deprecated APIs and configuration properties
