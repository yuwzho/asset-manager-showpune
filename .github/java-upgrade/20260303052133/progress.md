# Upgrade Progress
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.3.x
      ...
      - Updated parent pom.xml: spring-boot-starter-parent version upgraded from 3.2.1 to 3.3.x
      - Updated config classes: BeanMethodsNotPublic applied to AwsS3Config.java and RabbitConfig.java in both web and worker modules
      - Updated S3Controller.java: ImplicitWebAnnotationNames recipe applied
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot to 3.4.3
      - Updated parent pom.xml: spring-boot-starter-parent version from 3.3.13 to 3.4.3
      - Removed temporary rewrite.yml configuration file
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      - org.springframework.boot:spring-boot-starter-thymeleaf:3.4.3:jar
      - org.springframework.boot:spring-boot-starter-web:3.4.3:jar
      - org.springframework.boot:spring-boot-starter-amqp:3.4.3:jar
      - org.springframework.boot:spring-boot-devtools:3.4.3:jar
      - org.springframework.boot:spring-boot-configuration-processor:3.4.3:jar
      - org.projectlombok:lombok:1.18.36:jar
      - org.springframework.boot:spring-boot-starter-test:3.4.3:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.4.3:jar
      - org.postgresql:postgresql:42.7.5:jar
      - com.h2database:h2:2.3.232:jar
      - org.springframework.boot:spring-boot-starter:3.4.3:jar
      - org.springframework.boot:spring-boot-starter-amqp:3.4.3:jar
      - org.projectlombok:lombok:1.18.36:jar
      - org.springframework.boot:spring-boot-starter-test:3.4.3:jar
    ...
    #### Code changes
    - Fix CVE-2025-49146 in org.postgresql:postgresql
      - Added postgresql.version=42.7.7 property override in root pom.xml to upgrade from 42.7.5 to 42.7.7
    </details>
