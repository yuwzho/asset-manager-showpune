# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.2.1 to 3.3.13
      - Updated parent pom.xml spring-boot-starter-parent version to 3.3.13
    - Upgrade Java from 17 to 21
      - Updated java.version property in pom.xml to 21
    - OpenRewrite recipe applied code changes
      - Updated RabbitConfig classes in web and worker modules for Spring AMQP API changes
      - Updated AwsS3Config classes for API compatibility
      - Updated S3Controller for API compatibility
      - Updated LocalFileStorageService and LocalFileProcessingService for Java 21 compatibility
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot from 3.3.13 to 3.4.7
      - Updated parent pom.xml spring-boot-starter-parent version from 3.3.13 to 3.4.7
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      ...
      - org.springframework.boot:spring-boot-starter-amqp:3.4.7:jar
      - org.springframework.boot:spring-boot-devtools:3.4.7:jar
      - org.springframework.boot:spring-boot-configuration-processor:3.4.7:jar
      ...
      - org.springframework.boot:spring-boot-starter:3.4.7:jar
      - org.springframework.boot:spring-boot-starter-amqp:3.4.7:jar
      - org.projectlombok:lombok:1.18.38:jar
      - org.springframework.boot:spring-boot-starter-test:3.4.7:jar
      - com.fasterxml.jackson.core:jackson-databind:2.18.4:jar
      - org.springframework.boot:spring-boot-starter-data-jpa:3.4.7:jar
      - org.postgresql:postgresql:42.7.7:jar
      - java:*:21
    </details>
