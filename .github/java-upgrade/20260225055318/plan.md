...
- **Working branch**: appmod/java-upgrade-20260225055318
  - Note: <span style="color:#FF9900">There are uncommitted changes in the project, which will be stashed before upgrading.</span>
- **Java version**: 17
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260225055318`.
