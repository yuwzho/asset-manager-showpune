# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Java version to 21 and Spring Boot to 3.4.2
      - Applied OpenRewrite recipe org.openrewrite.java.migrate.UpgradeToJava21 to migrate code to Java 21
      - Updated java.version property from 17 to 21 in parent pom.xml
      - Updated Spring Boot parent version from 3.2.1 to 3.4.2 in parent pom.xml
    </details>
  ...
  - ###
    ...
    #### Checked Dependencies
      ...
      - org.springframework.boot:spring-boot-starter-amqp:3.4.2:jar
      - org.springframework.boot:spring-boot-devtools:3.4.2:jar
      - org.springframework.boot:spring-boot-configuration-processor:3.4.2:jar
      ...
      - org.springframework.boot:spring-boot-starter:3.4.2:jar
      - org.springframework.boot:spring-boot-starter-amqp:3.4.2:jar
      - org.projectlombok:lombok:1.18.36:jar
      - org.springframework.boot:spring-boot-starter-test:3.4.2:jar
    ...
    ### ✅ Fix CVE Issues
    - [[View Log]](logs\6.2.fixCveIssues.log)
    ...
    - Fix CVE-2025-49146 in PostgreSQL JDBC driver
      - Override postgresql.version property to 42.7.7 in parent pom.xml to upgrade from 42.7.5
    </details>
  
    ### ✅ Build Project
    - [[View Log]](logs\6.3.buildProject.log)
    ...
    ### ✅ Validate CVEs
    - [[View Log]](logs\6.4.validateCves.log)
    ...
    - [[View Log]](logs\6.5.validateBehaviorChanges.log)
  
    ### ✅ Run Tests
    - [[View Log]](logs\6.6.runTests.log)
