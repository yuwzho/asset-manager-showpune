# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Apply OpenRewrite UpgradeSpringBoot_3_3 recipe
      - Upgraded Spring Boot parent from 3.2.1 to 3.3.x
      - Updated Java source/target compatibility to Java 21
      - Updated related dependency versions for compatibility
    - Apply OpenRewrite UpgradeToJava21 recipe
      - Updated Java language features and APIs to Java 21
    </details>
  ...
  - ###
    ...
    - Upgrade Spring Boot parent from 3.3.13 to 3.4.5
      - Updated spring-boot-starter-parent version in root pom.xml to 3.4.5
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade postgresql driver to fix CVE-2025-49146
      - Added postgresql.version=42.7.7 property to root pom.xml to override Spring Boot managed version 42.7.5
    </details>
