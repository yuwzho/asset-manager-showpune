# Upgrade Progress
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.2.1 to 3.3.13 and Java from 17 to 21
      - Updated `pom.xml`: Spring Boot version 3.2.1 → 3.3.13, java.version 17 → 21
      - Updated `AwsS3Config.java` (web and worker): minor code changes by OpenRewrite
      - Updated `RabbitConfig.java` (web and worker): minor code changes by OpenRewrite
      - Updated `S3Controller.java`: minor code changes by OpenRewrite
      - Updated `LocalFileStorageService.java` and `LocalFileProcessingService.java`: minor code changes by OpenRewrite
    </details>
  ...
  - ###
    ...
    #### Code changes
    - Upgrade Spring Boot from 3.3.13 to 3.4.5 (Milestone 2)
      - Updated `pom.xml`: Spring Boot version 3.3.13 → 3.4.5
    </details>
  ...
  - ###
    ...
    - Fix CVE-2025-49146 in `org.postgresql:postgresql`
      - Added `postgresql.version` property in root `pom.xml` to override the Spring Boot managed version, upgrading from 42.7.5 to 42.7.7
    </details>
