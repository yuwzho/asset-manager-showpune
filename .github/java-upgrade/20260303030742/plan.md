...
- Upgrade JDK to 21
- Upgrade Spring Boot to 3.4 (latest patch version 3.4.x)
- Spring Framework to 6.x (comes with Spring Boot 3.4)
- Migrate javax.* to jakarta.* namespace if present
- Update deprecated APIs
- Ensure all dependencies are compatible with target versions
- NEVER discard any existing changes
- Reuse the current branch
